...
+ MS 사에서 다양한 모바일 기기나 데스크탑에서 두루두루 사용할 수 있게끔 만들어 놓은 프레임워크.
  - 사람들이 윈도우만 쓰는 것이 아니라, 다른 다양한 OS위에서 프로그램을 사용하는데, 윈도우용 프로그램은 오직 윈도우에서만 동작하기 때문에 위기를 느낀 MS사에서 이런 프레임워크를 만들었다. 
